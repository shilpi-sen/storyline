...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'storyline' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'storyline' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'storyline' ),
		'repeat'    => esc_html__( 'Repeat All', 'storyline' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'storyline' ),
		'top center'    => esc_html__( 'Top Center', 'storyline' ),
		'top right'     => esc_html__( 'Top Right', 'storyline' ),
		'center left'   => esc_html__( 'Middle Left', 'storyline' ),
		'center center' => esc_html__( 'Middle Center', 'storyline' ),
		'center right'  => esc_html__( 'Middle Right', 'storyline' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'storyline' ),
		'bottom center' => esc_html__( 'Bottom Center', 'storyline' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'storyline')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'storyline' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'storyline')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'storyline' ),
		'italic'      => esc_html__( 'Italic', 'storyline' ),
		'bold'        => esc_html__( 'Bold', 'storyline' ),
		'bold italic' => esc_html__( 'Bold Italic', 'storyline' )
		);
